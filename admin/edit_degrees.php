...
include(header);
$c_id = $_GET['id'];
$qry = "SELECT * FROM `degrees` WHERE `id` = '$c_id'";
...
<div class="page-wrapper">
    <div class="page-content">
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            <div>
                <h4 class="mb-3 mb-md-0">Edit Degree</h4>
            </div>
                            ...
                            <div class="card-body">
                                <form class="forms-sample" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="category" value="<?= $d_qry->name ?>" placeholder="Degree" name="category">
                                    </div>
                                ...
                                if (isset($_POST['add_cat'])) {
                                    ...
                                    $stmt = "UPDATE `degrees` SET `name` = '$category' WHERE `id` = '$c_id'";
                                    $run = $conn->query($stmt);
                                    if ($run) {
