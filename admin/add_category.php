...
<div class="page-wrapper">
                            ...
                            <div class="card-body">
                                <form class="forms-sample" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="category" autocomplete="off" placeholder="Category" name="category">
                                    </div>
                                ...
                                if (isset($_POST['add_cat'])) {
                                    ...
                                    $stmt = "INSERT INTO `categories` (`name`,`status`) VALUES ('$category', '1')";
                                    $run = $conn->query($stmt);
                                    if ($run) {
    ...
    <script>
        document.title = "Add Category - Purulia Doctors Admin"
    </script>
    <?php include(footer); ?>